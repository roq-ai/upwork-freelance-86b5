        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              ...
              isInvalid: !!formik.errors?.endorsement_count,
            }}
            name="endorsement_count"
            error={formik.errors?.endorsement_count}
            value={formik.values?.endorsement_count}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('endorsement_count', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
