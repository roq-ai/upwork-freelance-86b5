  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Upwork Freelancer Site, your global platform for connecting with professionals and launching your freelance career to new heights."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Upwork Freelancer Site, your global platform for connecting with professionals and launching your freelance career to new heights.`}
            </Text>
            <Box
